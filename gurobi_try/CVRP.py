...
if __name__=='__main__':
    depot,C,N,Q,Cost=readXlsxFile(filename=r'C:\Users\ryw03\Downloads\modeling_examples_using_gurobi_in_python-master\modeling_examples_using_gurobi_in_python-master\dataset\CVRP\cvrp_for_gurobi.xlsx')
    solveCVRPModel(depot=depot, C=C, N=N, Q=Q, Cost=Cost, n_vehicles=5, CAP=30)
