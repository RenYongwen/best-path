...
# 每辆车的路线必须首尾相连（矩阵列和为偶数）
# model.addConstrs(quicksum(INDIC_XTP[x, t, p1] * INDIC_XTP[x, (t + 1) % max_time, p2] for p1, p2 in CONNS) == 1 for x, t in K_XT)
